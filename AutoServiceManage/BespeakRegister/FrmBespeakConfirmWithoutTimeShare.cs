...
{
    public partial class FrmBespeakConfirmWithoutTimeShare : Form
    {
        public FrmBespeakConfirmWithoutTimeShare()
        {
            InitializeComponent();
        }
        ...
        private void FrmBespeakConfirmWithoutTimeShare_Load(object sender, EventArgs e)
        {
            ...
            if (BespeakDataset != null && BespeakDataset.Tables.Count > 0 && BespeakDataset.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    this.lblDate.Text = "预约时间：" + Convert.ToDateTime(BespeakDataset.Tables[0].Rows[0]["BESPEAKDATE"].ToString()).ToShortDateString();
                    label1.Text = "确认预约信息";
        ...
        private void FrmBespeakConfirmWithoutTimeShare_FormClosing(object sender, FormClosingEventArgs e)
        {
